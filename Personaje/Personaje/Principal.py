...
def main():
    ...
    personaje = pygame.image.load("../Imagenes/Guason.png").convert_alpha()
    disparo = pygame.image.load("../Imagenes/disparo.png").convert_alpha()
    risajoker = pygame.mixer.music.load("../Sonido/joker.mp3")
    player = Player(personaje,disparo,risajoker)
